...
writing the output to file).  As with any R package, detailed information 
...
\begin{center}
\texttt{http://genomine.org/qvalue/results.html}.
\end{center}
...
\section{The qvalue Shiny app}

A point-and-click version of qvalue can be accessed at \texttt{http://qvalue.princeton.edu/}.
